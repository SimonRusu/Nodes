...
def graph_search(problem, fringe):
    ...
    while fringe:
        ...
        if problem.goal_test(node.state):
            print('Numero de nodos visitados= ' + str(counter) + '. Numero de nodos escogidos= ' + str(len(node.path())) )
            return node
...
#---------------------------------------
def bnb_first_graph_search(problem):
    """Search the deepest nodes in the search tree first. [p 74]"""
    return graph_search(problem, PriorityQueue())
#---------------------------------------

def bnb_heur_first_graph_search(problem):
    return graph_search(problem,BnbHeur(gps=GPSProblem(problem.initial,problem.goal,romania)))
